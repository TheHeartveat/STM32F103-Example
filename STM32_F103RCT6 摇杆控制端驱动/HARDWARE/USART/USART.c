...
//	{
//	    if(a/16>=130)USART_SendData(USART1,1);//前进
//			if(a/16<=110)USART_SendData(USART1,2);//后退
//			if(temp/16>=130)USART_SendData(USART1,3);//左转
//			if(temp/16<=110&a/16<130&a/16>110)USART_SendData(USART1,4);//右转
//			if(temp/16>=130&a/16>=130)USART_SendData(USART1,5);//左转圈
//			if(temp/16<=110&a/16>=130)USART_SendData(USART1,6);//右转圈
//	}
//	
//	
//}
